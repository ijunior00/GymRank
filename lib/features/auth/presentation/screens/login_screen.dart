...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        // Em tela pequena (iPhone SE) ou com o teclado aberto isto não
        // cabe. Rolando, cabe sempre; quando sobra espaço os Spacer
        // continuam centralizando como antes.
        child: LayoutBuilder(
